...
pub(super) struct StrategyOpIdentityTransferFormController {
    input: ComposedInput<(Field<SelectInput<u16>>, Field<SelectInput<f64>>)>,
    selected_strategy: String,
}

impl StrategyOpIdentityTransferFormController {
    pub(super) fn new(selected_strategy: String) -> Self {
        StrategyOpIdentityTransferFormController {
...
impl FormController for StrategyOpIdentityTransferFormController {
